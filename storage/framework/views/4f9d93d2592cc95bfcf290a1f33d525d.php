            ...
            <div class="card-body p-4 position-relative z-1 text-white">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                    <div>
                        ...
                        <h2 class="h3 fw-bold mb-1 text-white">Edit Data User</h2>
                        <p class="text-white-50 small mb-0">Perbarui profil dan peran pengguna sesuai kebutuhan operasional.</p>
                    </div>
                    <div>
                        <a href="<?php echo e(route('admin.users')); ?>" class="btn btn-outline-light rounded-pill px-3 py-2 fs-7">
                ...
                <div class="card border-0 shadow-sm rounded-4 bg-white overflow-hidden form-card">
                    <div class="card-header bg-white border-bottom border-light-subtle py-3 px-4">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <h5 class="card-title fw-bold text-dark mb-0 fs-6">Edit User</h5>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\APK_POS2\resources\views\users\edit.blade.php ENDPATH**/ ?>