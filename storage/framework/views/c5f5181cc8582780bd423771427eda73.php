...
<?php $__env->startSection('title', 'POS - Kasir Penjualan'); ?>
        ...
        <div class="col-lg-6">
            ...
            <div class="card border-0 shadow-sm rounded-4 bg-white h-100 overflow-hidden">
                ...
                <div class="card-header bg-white border-0 pt-4 px-4 pb-2">
                    ...
                    <form method="GET"
                          action="<?php echo e(route('penjualan.edit', $sale->id)); ?>">
                        ...
                        <div class="input-group rounded-pill overflow-hidden bg-body-tertiary border border-light-subtle">
                            ...
                            <?php if(request('search')): ?>
                                ...
                                <a href="<?php echo e(route('penjualan.edit', $sale->id)); ?>"
                                        ...
                                        <div class="row g-2 align-items-center">
                                            ...
                                            <div class="col-6 col-md-7">
                                                ...
                                                <div class="small text-muted fw-semibold">
                                                    ...
                                                    Rp
                                                    <?php echo e(number_format($product->harga_jual ?? 0, 0, ',', '.')); ?>
            ...
            <div class="card border-0 shadow-sm rounded-4 bg-white h-100 overflow-hidden d-flex flex-column">
                ...
                <div class="card-header bg-white border-0 pt-4 px-4 pb-2">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <?php if(in_array($status, ['COMPLETED', 'SELESAI', 'PAID'])): ?>
                        ...
                        <?php else: ?>
                            ...
                            <span class="badge border border-warning-subtle bg-warning-subtle text-warning-emphasis px-3 py-1 rounded-pill fw-semibold">
                                ...
                                Status: <?php echo e(ucfirst(strtolower($sale->status ?? 'OPEN'))); ?>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $sale->itemPenjualan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-3 fs-7 text-secondary">
                                            ...
                                            Rp
                                            <?php echo e(number_format($item->harga_satuan ?? $item->produk->harga_jual ?? 0, 0, ',', '.')); ?>
                                        ...
                                        <td class="py-3 fs-7 fw-bold text-dark">
                                            ...
                                            Rp
                                            <?php echo e(number_format($item->subtotal ?? 0, 0, ',', '.')); ?>
                ...
                <div class="card-footer bg-white border-top p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <span class="h4 fw-bold text-dark mb-0">
                            ...
                            Rp
                            <?php echo e(number_format($sale->total_pembayaran ?? 0, 0, ',', '.')); ?>
                    ...
                    <form method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <select
                                ...
                                <option value="CASH"
                                    <?php echo e(strtoupper($sale->metode_pembayaran ?? '') === 'CASH' ? 'selected' : ''); ?>>
                                ...
                                <option value="QRIS"
                                    <?php echo e(strtoupper($sale->metode_pembayaran ?? '') === 'QRIS' ? 'selected' : ''); ?>>
                                ...
                                <option value="TRANSFER"
                                    <?php echo e(strtoupper($sale->metode_pembayaran ?? '') === 'TRANSFER' ? 'selected' : ''); ?>>
                        ...
                        <div id="qris-payment-panel"
                            ...
                            <div class="d-flex flex-column flex-sm-row align-items-center gap-3">
                                ...
                                <div class="small text-secondary text-center text-sm-start">
                                    <div class="fw-semibold text-dark mb-1">Total: Rp <?php echo e(number_format($sale->total_pembayaran ?? 0, 0, ',', '.')); ?></div>
                        ...
                        <button
                            ...
                            <?php echo e((!$hasItems || $isCompleted) ? 'disabled' : ''); ?>>
