        ...
        <div class="card border-0 rounded-4 shadow-sm overflow-hidden mb-4 dashboard-hero">
            <div class="card-body p-4 position-relative z-1 text-white">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                    ...
                    <div>
                        <a href="<?php echo e(route('jenis.create')); ?>" class="btn btn-info fw-bold text-dark shadow-sm rounded-pill px-4 py-2 border-0">
                ...
                <div class="row g-3 align-items-center justify-content-between">
                    <div class="col-12 col-md-6 col-lg-4">
                        <form action="<?php echo e(route('jenis.index')); ?>" method="GET">
                            <div class="input-group rounded-pill overflow-hidden bg-body-tertiary border border-light-subtle shadow-sm">
                                ...
                                <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control bg-transparent border-0 ps-2 fs-7 shadow-none text-dark" placeholder="Cari jenis...">
                                <?php if(request('search')): ?>
                                    <a href="<?php echo e(route('jenis.index')); ?>" class="btn bg-transparent border-0 text-secondary pe-2">
                    ...
                    <div class="col-12 col-md-auto text-secondary small fw-medium">
                        <span class="d-inline-block px-3 py-1 rounded-pill bg-light-subtle border border-light-subtle">
                            <i class="bi bi-database-check me-1 text-primary"></i> Total Jenis: <strong class="text-dark"><?php echo e($jenis->total()); ?></strong>
                        </span>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $jenis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="ps-4 text-muted py-3 fs-7"><?php echo e($jenis->firstItem() + $loop->index); ?></td>
                                    <td class="py-3">
                                        <span class="fw-semibold text-dark"><?php echo e($item->nama_jenis); ?></span>
                                    </td>
                                    <td class="py-3 text-secondary fs-7"><?php echo e($item->deskripsi ?: '-'); ?></td>
                                    <td class="pe-4 py-3 text-end">
                                        <div class="d-inline-flex gap-1">
                                            <a href="<?php echo e(route('jenis.edit', ['jeni' => $item->id])); ?>" class="btn btn-sm btn-light border text-warning-emphasis hover-action-btn rounded-circle p-2 d-inline-flex align-items-center justify-content-center" style="width: 36px; height: 36px;" title="Edit Jenis">
                                                <i class="bi bi-pencil-fill"></i>
                                            </a>

                                            <form action="<?php echo e(route('jenis.destroy', ['jeni' => $item->id])); ?>" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus jenis ini?')">
                                                <?php echo csrf_field(); ?>
