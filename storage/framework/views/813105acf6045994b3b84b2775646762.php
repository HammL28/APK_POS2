...
<?php $__env->startSection('title', 'Pengaturan Struk & Branding - POS System'); ?>
                ...
                <div class="card dashboard-card h-100">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="receipt_header_title" id="receipt_header_title" class="form-control" placeholder="Toko Maju Jaya POS" value="<?php echo e(old('receipt_header_title', $user->store_name ?? '')); ?>">
                        </div>

                        <div class="mb-3">
                            <label for="receipt_address" class="form-label">Alamat Toko</label>
                            <textarea name="receipt_address" id="receipt_address" class="form-control" rows="2" placeholder="Jl. Sudirman No. 123, Jakarta"><?php echo e(old('receipt_address', $user->store_address ?? '')); ?></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="receipt_phone" class="form-label">Nomor Telepon / WhatsApp</label>
                            <input type="text" name="receipt_phone" id="receipt_phone" class="form-control" placeholder="0812-3456-7890" value="<?php echo e(old('receipt_phone', $user->store_phone ?? '')); ?>">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="p-3 mb-3 border rounded-3 bg-light">
                            ...
                            <div class="row g-2">
                                <div class="col-md-7">
                                    ...
                                    <input type="text" name="bca_account_number" class="form-control form-control-sm" placeholder="Contoh: 1234567890" value="<?php echo e(old('bca_account_number', $user->bca_account_number ?? '1234567890')); ?>">
                                </div>
                                <div class="col-md-5">
                                    <label class="form-label small mb-1">Atas Nama (A.N)</label>
                                    <input type="text" name="bca_account_holder" class="form-control form-control-sm" placeholder="A.N Pemilik" value="<?php echo e(old('bca_account_holder', $user->bca_account_holder ?? 'PT TOKO KASIR POS')); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-3 border rounded-3 bg-light">
                            ...
                            <div class="row g-2">
                                <div class="col-md-7">
                                    ...
                                    <input type="text" name="mandiri_account_number" class="form-control form-control-sm" placeholder="Contoh: 1370001234567" value="<?php echo e(old('mandiri_account_number', $user->mandiri_account_number ?? '1370001234567')); ?>">
                                </div>
                                <div class="col-md-5">
                                    <label class="form-label small mb-1">Atas Nama (A.N)</label>
                                    <input type="text" name="mandiri_account_holder" class="form-control form-control-sm" placeholder="A.N Pemilik" value="<?php echo e(old('mandiri_account_holder', $user->mandiri_account_holder ?? 'PT TOKO KASIR POS')); ?>">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="sidebar_brand_text" id="sidebar_brand_text" class="form-control" maxlength="50" placeholder="POS ILHAM" value="<?php echo e(old('sidebar_brand_text', $user->sidebar_brand_text ?? 'POS ILHAM')); ?>">
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <select name="sidebar_logo_shape" id="sidebar_logo_shape" class="form-select">
                                    <option value="circle" <?php echo e(old('sidebar_logo_shape', $user->sidebar_logo_shape ?? 'circle') === 'circle' ? 'selected' : ''); ?>>Lingkaran</option>
                                    <option value="square" <?php echo e(old('sidebar_logo_shape', $user->sidebar_logo_shape ?? 'circle') === 'square' ? 'selected' : ''); ?>>Kotak Membulat</option>
                                </select>
                            </div>

                            <div class="col-md-6">
                                <label for="sidebar_color_from" class="form-label">Warna Awal Gradasi</label>
                                <input type="color" name="sidebar_color_from" id="sidebar_color_from" class="form-control form-control-color w-100" value="<?php echo e(old('sidebar_color_from', $user->sidebar_color_from ?? '#4f46e5')); ?>">
                            </div>

                            <div class="col-md-6">
                                <label for="sidebar_color_to" class="form-label">Warna Akhir Gradasi</label>
                                <input type="color" name="sidebar_color_to" id="sidebar_color_to" class="form-control form-control-color w-100" value="<?php echo e(old('sidebar_color_to', $user->sidebar_color_to ?? '#e879f9')); ?>">
                            </div>
                            ...
                            <div class="col-lg-7">
                                ...
                                <?php if(!empty($user->sidebar_bg_photo) && \Illuminate\Support\Facades\Storage::disk('public')->exists($user->sidebar_bg_photo)): ?>
                                    <img src="<?php echo e(asset('storage/' . $user->sidebar_bg_photo)); ?>" alt="Logo sidebar saat ini" class="current-photo-preview mt-2">
                                <?php endif; ?>
                            </div>

                            <div class="col-lg-5">
                                <label for="sidebar_bg_opacity" class="form-label">Transparansi Logo: <span id="sidebarOpacityValue"><?php echo e(old('sidebar_bg_opacity', $user->sidebar_bg_opacity ?? 25)); ?>%</span></label>
                                <input type="range" name="sidebar_bg_opacity" id="sidebar_bg_opacity" class="form-range mt-2" min="0" max="80" value="<?php echo e(old('sidebar_bg_opacity', $user->sidebar_bg_opacity ?? 25)); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cadisetrama\resources\views/settings/index.blade.php ENDPATH**/ ?>