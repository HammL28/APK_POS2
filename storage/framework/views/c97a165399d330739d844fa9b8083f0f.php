...
<?php $__env->startSection('title', 'Dashboard Performance'); ?>
                    ...
                    <div class="metric-card card border-0 h-100">
                        <div class="card-body p-3 p-md-4 d-flex align-items-center gap-3">
                            ...
                            <div class="overflow-hidden">
                                ...
                                <h4 class="metric-value mb-0">Rp <?php echo e(number_format($ringkasan['total_penjualan'], 0, ',', '.')); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="metric-card card border-0 h-100">
                        <div class="card-body p-3 p-md-4 d-flex align-items-center gap-3">
                            ...
                            <div class="overflow-hidden">
                                ...
                                <h4 class="metric-value mb-0"><?php echo e(number_format($ringkasan['total_transaksi'], 0, ',', '.')); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="metric-card card border-0 h-100">
                        <div class="card-body p-3 p-md-4 d-flex align-items-center gap-3">
                            ...
                            <div class="overflow-hidden">
                                ...
                                <h4 class="metric-value mb-0">Rp <?php echo e(number_format($ringkasan['total_cash'], 0, ',', '.')); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="metric-card card border-0 h-100">
                        <div class="card-body p-3 p-md-4 d-flex align-items-center gap-3">
                            ...
                            <div class="overflow-hidden">
                                ...
                                <h4 class="metric-value mb-0">Rp <?php echo e(number_format($ringkasan['total_non_tunai'], 0, ',', '.')); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $produkStokRendah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-muted small"><?php echo e($produkStokRendah->firstItem() + $index); ?></td>
                            ...
                            <table class="table align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $produkStokHabis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-muted small"><?php echo e($produkStokHabis->firstItem() + $index); ?></td>
                                            <td class="fw-semibold text-dark"><?php echo e($produk->nama); ?></td>
                                            <td class="text-end">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $produkTerlaris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class="text-secondary"><?php echo e($produk->stok); ?> unit</td>
                                    <td class="text-end">
                                        <span class="status-badge success">
                                            <i class="bi bi-graph-up me-1"></i><?php echo e($produk->total_terjual); ?> Terjual
                                        </span>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
