...
<div class="sidebar-wrapper"
     id="sidebar"
     style="--custom-color-from: <?php echo e($sbColorFrom); ?>; --custom-color-to: <?php echo e($sbColorTo); ?>;">

    <!-- HEADER -->
    <div class="sidebar-header">

        <?php if($sbHasPhoto): ?>
            <div class="sidebar-brand-logo-box <?php echo e($sbLogoShape === 'circle' ? 'shape-circle' : ''); ?>">
                <img src="<?php echo e(asset('storage/' . $sbConfigUser->sidebar_bg_photo)); ?>" alt="Logo Toko" style="opacity: <?php echo e(1 - (($sbConfigUser->sidebar_bg_opacity ?? 25) / 100)); ?>;">
            </div>
        <?php endif; ?>

        <div class="sidebar-brand-text"><?php echo e($sbBrandText); ?></div>
    </div>

    <!-- MENU -->
    <ul class="sidebar-menu">
        <li class="sidebar-menu-item">
            <a class="sidebar-menu-link <?php echo e(Request::is('dashboard*') ? 'active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">
        ...
        <?php if(Auth::check() && strtolower($userRole) === 'admin'): ?>
        <li class="sidebar-menu-item">
            <a class="sidebar-menu-link <?php echo e(Request::is('admin/users*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.users')); ?>">
        ...
        <li class="sidebar-menu-item">
            <a class="sidebar-menu-link <?php echo e(Request::is('jenis*') ? 'active' : ''); ?>" href="<?php echo e(route('jenis.index')); ?>">
        ...
        <li class="sidebar-menu-item">
            <a class="sidebar-menu-link <?php echo e(Request::is('produk*') ? 'active' : ''); ?>" href="<?php echo e(route('produk.index')); ?>">
        ...
        <li class="sidebar-menu-item">
            <a class="sidebar-menu-link <?php echo e(Request::is('penjualan*') ? 'active' : ''); ?>" href="<?php echo e(route('penjualan.index')); ?>">
        ...
        <li class="sidebar-menu-item">
            <a class="sidebar-menu-link <?php echo e(Request::is('profile*') ? 'active' : ''); ?>" href="<?php echo e(route('profile.index')); ?>">
        ...
        <?php if(Auth::check() && strtolower($userRole) === 'admin'): ?>
        <li class="sidebar-menu-item">
            <a class="sidebar-menu-link <?php echo e(Request::is('settings*') ? 'active' : ''); ?>" href="<?php echo e(route('settings.index')); ?>">
        ...
        <li class="sidebar-menu-item">
            <a class="sidebar-menu-link <?php echo e(Request::is('tentang*') ? 'active' : ''); ?>" href="<?php echo e(route('tentang.index')); ?>">
    ...
    <div class="sidebar-footer">
        ...
        <div class="sidebar-user-card">
            <a href="<?php echo e(route('profile.index')); ?>" class="sidebar-user-avatar" title="Lihat & Edit Profil">
                <?php if(Auth::user()->photo && Storage::disk('public')->exists(Auth::user()->photo)): ?>
                    <img src="<?php echo e(asset('storage/' . Auth::user()->photo)); ?>" alt="Foto Pengguna">
                <?php else: ?>
                    <i class="bi bi-person-fill"></i>
                <?php endif; ?>
            </a>
            <div class="sidebar-user-info">
                <div class="sidebar-user-name"><?php echo e(Auth::user()->name ?? 'Kasir'); ?></div>
                <div class="sidebar-user-role">
                    <?php echo e(Auth::user()->role->name ?? Auth::user()->role->NAME ?? (is_string(Auth::user()->role) ? Auth::user()->role : 'Staf')); ?>

                </div>
            </div>
            <a href="<?php echo e(route('logout')); ?>" class="sidebar-logout-btn" title="Keluar" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
...
</script><?php /**PATH C:\laragon\www\cadisetrama\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>