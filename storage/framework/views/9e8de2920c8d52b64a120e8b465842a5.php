...
<?php $__env->startSection('title', 'Kelola Users - POS System'); ?>
    ...
    <div class="dashboard-header-banner mb-4">
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 position-relative" style="z-index: 1;">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <a href="<?php echo e(route('admin.users.create')); ?>" class="btn btn-light rounded-pill px-4 shadow-sm fw-bold d-inline-flex align-items-center gap-2" style="color: var(--text-purple-accent) !important;">
            ...
            <div class="card dashboard-card h-100 p-3">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="h-metric-value mb-1">
                        <?php echo e(method_exists($users, 'total') ? $users->total() : count($users)); ?>
        ...
        <div class="col-6 col-md-3">
            <div class="card dashboard-card h-100 p-3">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="h-metric-value mb-1">
                        <?php echo e($users->filter(fn($u) => strtolower(is_object($u->role) ? $u->role->name : $u->role ?? '') == 'admin')->count()); ?>
            ...
            <form action="<?php echo e(route('admin.users')); ?>" method="GET">
                <div class="row g-2 justify-content-between align-items-center">
                    ...
                    <div class="col-md-7 col-lg-6 d-flex align-items-center justify-content-md-end gap-2">
                        ...
                        <a href="<?php echo e(route('admin.users')); ?>" class="btn btn-sm btn-light rounded-pill px-3 border-0 d-inline-flex align-items-center gap-1" style="color: var(--text-muted);">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-4 fw-semibold" style="color: var(--text-muted); font-size: 0.8rem;">
                                <?php echo e(method_exists($users, 'firstItem') ? $users->firstItem() + $loop->index : $loop->iteration); ?>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="avatar-purple rounded-circle d-flex align-items-center justify-content-center shadow-sm overflow-hidden" style="width: 40px; height: 40px; flex-shrink: 0;">
                                        ...
                                        <img src="<?php echo e(asset('storage/' . $user->photo)); ?>"
                                            ...
                                            onerror="this.onerror=null; this.parentNode.innerHTML='<?php echo e(strtoupper(substr($user->name, 0, 1))); ?>';">
                                        <?php else: ?>
                                    ...
                                    <div>
                                        <span class="user-name-text d-block fw-bold" style="color: var(--text-heading); font-size: 0.925rem;"><?php echo e($user->name); ?></span>
                                        <span class="h-title-sub" style="font-size: 0.75rem;">ID User: #<?php echo e($user->id); ?></span>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center gap-1">
                                    ...
                                    <span class="fw-medium" style="color: var(--text-body);"><?php echo e($user->email); ?></span>
                                    <button type="button"
                                        class="btn btn-sm btn-link p-0 ms-1 border-0"
                                        style="color: var(--text-muted);"
                                        onclick="copyToClipboard('<?php echo e($user->email); ?>', this)"
                                        title="Salin Email">
                            ...
                            <td>
                                ...
                                <span class="badge badge-role-kasir px-3 py-1.5 rounded-pill d-inline-flex align-items-center gap-1">
                                    <i class="bi bi-person-badge"></i> <?php echo e(ucfirst($roleName)); ?>
                            ...
                            <td class="pe-4 text-end">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="btn-action-icon btn-edit-soft" title="Edit Akun">
                                    ...
                                    <?php else: ?>
                                        <button type="button"
                                            class="btn-action-icon btn-delete-soft"
                                            title="Hapus User"
                                            onclick="triggerDeletePopup('<?php echo e($user->id); ?>', '<?php echo e($user->name); ?>')">
                                            <i class="bi bi-trash-fill"></i>
                                        </button>

                                        
                                        <form id="deleteForm-<?php echo e($user->id); ?>" action="<?php echo e(route('admin.users.destroy', $user->id)); ?>" method="POST" class="d-none">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cadisetrama\resources\views/users/index.blade.php ENDPATH**/ ?>