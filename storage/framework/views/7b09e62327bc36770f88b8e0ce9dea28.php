            ...
            html: `
                <div class="p-2 text-center">
                    ...
                    <p class="text-muted small mb-4">
                        <?php echo e(session('status') ?? 'Kami telah menyiapkan tautan pemulihan kata sandi untuk akun Anda.'); ?>
                    ...
                    <a href="<?php echo e(session('demo_link')); ?>" class="btn text-white w-100 fw-semibold py-2 d-flex align-items-center justify-content-center gap-2 shadow-sm" style="background: linear-gradient(135deg, #2e1065 0%, #6d28d9 100%); border-radius: 12px; font-family: var(--font-heading);">
...
</html><?php /**PATH C:\laragon\www\cadisetrama\resources\views/login.blade.php ENDPATH**/ ?>