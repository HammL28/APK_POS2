    ...
    <div class="container-fluid px-3 px-md-4">
            ...
            <div class="card-body p-4 position-relative z-1 text-white">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                    <div>
                        ...
                        <h2 class="h3 fw-bold mb-1 text-white">Detail Penjualan #<?php echo e($sale->id); ?></h2>
                        <p class="text-white-50 small mb-0">Informasi lengkap transaksi, data kasir, dan daftar item produk.</p>
                    </div>
                    <div class="d-flex flex-wrap gap-2">
                        <a href="<?php echo e(route('penjualan.index')); ?>" class="btn btn-outline-light rounded-pill px-4 py-2 border-opacity-25 fs-7">
                            <i class="bi bi-arrow-left me-1"></i> Kembali
                        </a>
                        <?php if(strtoupper($sale->status ?? '') !== 'COMPLETED' && strtoupper($sale->status ?? '') !== 'SELESAI'): ?>
                            <a href="<?php echo e(route('penjualan.edit', $sale->id)); ?>" class="btn btn-warning text-dark fw-semibold rounded-pill px-4 py-2 fs-7 border-0 shadow-sm">
                            ...
                            <table class="table table-borderless align-middle mb-0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="fw-bold text-dark fs-7 py-2">: #<?php echo e($sale->id); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-secondary ps-0 fs-7 py-2">Tanggal & Waktu</td>
                                        <td class="fw-semibold text-dark fs-7 py-2">
                                            : <?php echo e(\Carbon\Carbon::parse($sale->created_at)->format('d/m/Y H:i:s')); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fs-7 py-2">
                                            <span class="d-inline-flex align-items-center">
                                                ...
                                                ?>
                                                <?php if(in_array($st, ['COMPLETED', 'SELESAI', 'PAID'])): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fs-7 py-2">
                                            : <span class="badge bg-light text-dark border px-2.5 py-1 rounded-2 fw-semibold"><?php echo e($sale->metode_pembayaran ?? 'CASH'); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-secondary ps-0 fs-7 py-2">Total Pembayaran</td>
                                        <td class="fw-bold text-dark h5 mb-0 py-2">
                                            : <span class="text-success">Rp <?php echo e(number_format($sale->total_pembayaran, 0, ',', '.')); ?></span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-borderless align-middle mb-0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="fw-bold text-dark fs-7 py-2">: <?php echo e($sale->user->name ?? 'Kasir Tidak Ditemukan'); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="text-secondary ps-0 fs-7 py-2">Email Kasir</td>
                                        <td class="fw-semibold text-dark fs-7 py-2">: <?php echo e($sale->user->email ?? '-'); ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="fs-7 py-2">
                                            : <span class="badge bg-body-tertiary text-secondary border px-2.5 py-1 rounded-pill fw-medium">
                                                <?php echo e($sale->user->role->name ?? 'Pengguna'); ?>
        ...
        <div class="card border-0 shadow-sm rounded-4 bg-white overflow-hidden mb-4">
            ...
            <div class="card-body p-0">
                <?php if(isset($sale->itemPenjualan) && $sale->itemPenjualan->count() > 0): ?>
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody class="border-top-0">
                                <?php $__currentLoopData = $sale->itemPenjualan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="ps-4 py-3 text-start fs-7 text-secondary"><?php echo e($loop->iteration); ?></td>
                            ...
                            <tfoot class="bg-light-subtle border-top">
                                <tr>
                                    ...
                                    <td class="pe-4 py-3 text-end fs-6 fw-bold text-dark">
                                        ...
                                        ?>
                                        Rp <?php echo e(number_format($totalSum, 0, ',', '.')); ?>
        ...
        <?php if(strtoupper($sale->status ?? '') === 'OPEN'): ?>
            <div class="d-flex justify-content-end mb-4">
                <form action="<?php echo e(route('penjualan.destroy', $sale->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus transaksi penjualan ini?')">
                    <?php echo csrf_field(); ?>
