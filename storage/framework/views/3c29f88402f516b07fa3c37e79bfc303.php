...
<?php $__env->startSection('title', __('Dashboard') . ' - Sistem POS'); ?>
...
<div class="container py-4" style="padding-top: 5rem;">
            ...
            <div class="col-lg-7">
                <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
                    <div class="date-badge">
                        ...
                        <span><?php echo e(__('Hari Ini')); ?> &bull; <?php echo e($tanggalHariIni->translatedFormat('l, d F Y')); ?></span>
                    </div>
                    <div class="date-badge">
                ...
                <p class="text-white-50 mb-0 fs-6"><?php echo e(__('Berikut adalah ringkasan performa toko Anda hari ini.')); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="h-title-main mb-0"><?php echo e(__('Ringkasan Penjualan')); ?></h2>
                <span class="h-title-sub"><?php echo e(__('Data transaksi dan pendapatan hari ini')); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="row g-3 mb-4">
            ...
            <div class="card dashboard-card h-100 p-3">
                ...
                <div class="card-body p-0">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <span class="h-metric-label"><?php echo e(__('Total Pendapatan')); ?></span>
                    ...
                    <span class="badge badge-purple rounded-pill py-1 px-2.5">
                        <i class="bi bi-arrow-up-short"></i> <?php echo e(__('Total Hari Ini')); ?>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card dashboard-card h-100 p-3">
                ...
                <div class="card-body p-0">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <span class="h-metric-label"><?php echo e(__('Total Transaksi')); ?></span>
                        <div class="icon-box-modern">
                            <i class="bi bi-receipt"></i>
                        </div>
                    </div>
                    <div class="h-metric-value mb-2">
                        <?php echo e(number_format($ringkasan['total_transaksi'], 0, ',', '.')); ?> <span class="fs-6 fw-semibold" style="color: var(--text-muted);"><?php echo e(__('Transaksi')); ?></span>
                    </div>
                    <span class="h-title-sub"><?php echo e(__('Transaksi Berhasil')); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card dashboard-card h-100 p-3">
                ...
                <div class="card-body p-0">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <span class="h-metric-label"><?php echo e(__('Pembayaran Tunai')); ?></span>
                        <div class="icon-box-modern">
                    ...
                    <span class="h-title-sub"><?php echo e(__('Tunai Diterima')); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card dashboard-card h-100 p-3">
                ...
                <div class="card-body p-0">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <span class="h-metric-label"><?php echo e(__('Pembayaran Non-Tunai')); ?></span>
                        <div class="icon-box-modern">
                    ...
                    <span class="h-title-sub"><?php echo e(__('Pembayaran Digital')); ?></span>
                </div>
            </div>
        </div>
            ...
            <div class="card dashboard-card h-100">
                <div class="card-header bg-transparent border-0 pt-4 px-4 pb-2">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h3 class="h-title-main mb-0"><?php echo e(__('Produk Terlaris')); ?></h3>
                            <span class="h-title-sub"><?php echo e(__('Produk yang paling banyak diminati pelanggan')); ?></span>
                        </div>
                    </div>
                </div>
                <div class="card-body p-0 mt-2">
                    <div class="table-responsive">
                        <table class="table table-custom align-middle mb-0">
                            <thead>
                                <tr>
                                    <th class="ps-4"><?php echo e(__('Nama Produk')); ?></th>
                                    <th><?php echo e(__('Ketersediaan Stok')); ?></th>
                                    <th class="pe-4 text-end"><?php echo e(__('Total Penjualan')); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-purple px-3 py-1.5 rounded-pill">
                                            <?php echo e($produk->stok); ?> <?php echo e(__('Unit Tersedia')); ?>

                                        </span>
                                    </td>
                                    <td class="pe-4 text-end">
                                        <span class="badge badge-purple px-3 py-2 rounded-pill fw-bold">
                                            <i class="bi bi-bag-check-fill me-1"></i> <?php echo e(number_format($produk->total_terjual, 0, ',', '.')); ?> <?php echo e(__('Terjual')); ?>
                                ...
                                <tr>
                                    <td colspan="3" class="text-center py-5" style="color: var(--text-muted);">
                                        ...
                                        <span><?php echo e(__('Belum ada data produk terlaris')); ?></span>
                                    </td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="h-title-main mb-0"><?php echo e(__('Kondisi Stok')); ?></h2>
                <span class="h-title-sub"><?php echo e(__('Pantau stok produk yang hampir habis dan telah habis')); ?></span>
            </div>
        </div>
    </div>
            ...
            <div class="card dashboard-card h-100">
                <div class="card-header bg-transparent border-0 pt-4 px-4 pb-2 d-flex align-items-center justify-content-between">
                    <span class="fw-bold text-warning d-flex align-items-center gap-2 fs-6">
                        <i class="bi bi-exclamation-triangle-fill"></i> <?php echo e(__('Stok Menipis')); ?>

                    </span>
                    <span class="badge bg-warning-subtle text-warning border border-warning-subtle rounded-pill px-3 py-1 fw-bold">
                        <?php echo e(method_exists($produkStokRendah, 'count') ? $produkStokRendah->count() : count($produkStokRendah)); ?> <?php echo e(__('Item Produk')); ?>
                        ...
                        <table class="table table-custom align-middle mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="pe-4 text-end"><?php echo e(__('Sisa Stok')); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="3" class="text-center py-5" style="color: var(--text-muted);">
                                        ...
                                        <span><?php echo e(__('Semua stok dalam kondisi aman')); ?></span>
                                    </td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
            ...
            <div class="card dashboard-card h-100">
                <div class="card-header bg-transparent border-0 pt-4 px-4 pb-2 d-flex align-items-center justify-content-between">
                    <span class="fw-bold text-danger d-flex align-items-center gap-2 fs-6">
                        <i class="bi bi-x-circle-fill"></i> <?php echo e(__('Stok Habis')); ?>

                    </span>
                    <span class="badge bg-danger-subtle text-danger border border-danger-subtle rounded-pill px-3 py-1 fw-bold">
                        <?php echo e(method_exists($produkStokHabis, 'count') ? $produkStokHabis->count() : count($produkStokHabis)); ?> <?php echo e(__('Item Produk')); ?>
                        ...
                        <table class="table table-custom align-middle mb-0">
                            <thead>
                                <tr>
                                    <th class="ps-4" style="width: 60px;">#</th>
                                    <th><?php echo e(__('Nama Barang')); ?></th>
                                    <th class="pe-4 text-end"><?php echo e(__('Keterangan')); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="3" class="text-center py-5" style="color: var(--text-muted);">
                                        ...
                                        <span><?php echo e(__('Tidak ada produk yang habis')); ?></span>
                                    </td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cadisetrama\resources\views/dashboard.blade.php ENDPATH**/ ?>