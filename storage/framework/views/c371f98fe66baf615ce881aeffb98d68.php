...
<?php $__env->startSection('title', 'Edit Produk - ' . $produk->nama); ?>
    ...
    <div class="container-fluid px-3 px-md-4">
        ...
        <div class="card border-0 rounded-4 shadow-sm overflow-hidden mb-4" style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%);">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                    <div>
                        <div class="d-inline-flex align-items-center gap-2 px-3 py-1 rounded-pill bg-white bg-opacity-10 text-light mb-2 border border-white border-opacity-10">
                            ...
                            <span class="small fw-semibold">Inventory Update</span>
                        </div>
                        <h2 class="h3 fw-bold mb-1 text-white">Edit Produk</h2>
                        <p class="text-white-50 small mb-0">Ubah informasi produk, harga jual, harga beli, atau stok barang.</p>
                    </div>
                    <div>
                        <a href="<?php echo e(route('produk.index')); ?>" class="btn btn-outline-light rounded-pill px-3 py-2 fs-7">
            ...
            <div class="position-absolute end-0 bottom-0 opacity-10 me-n3 mb-n3 d-none d-md-block" style="pointer-events: none;">
                <i class="bi bi-pencil-fill display-1 text-white"></i>
            </div>
        </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 bg-white overflow-hidden">
                    <div class="card-header bg-white border-bottom border-light-subtle py-3 px-4">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <h5 class="card-title fw-bold text-dark mb-0 fs-6">Formulir Perubahan Data Produk</h5>
                        </div>
                    </div>
