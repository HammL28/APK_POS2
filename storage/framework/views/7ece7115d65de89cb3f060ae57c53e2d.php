...
<style>
    ...
    @media print {
        ...
        #receipt-print {
            ...
            left: 0;
            top: 0;
            width: <?php echo e($receiptPaperSize); ?>;
            max-width: <?php echo e($receiptPaperSize); ?>;
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="product-item" data-name="<?php echo e(strtolower($product->nama)); ?>">
                            <div class="product-card p-2.5 h-100">
                                ...
                                <form method="POST" action="<?php echo e(route('itempenjualan.store')); ?>" class="form-tambah-keranjang">
                                    <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-5 col-xl-4">
            <div class="cart-sticky-container">
                <div class="pos-card p-3 p-md-4">
                    ...
                    <div class="cart-items-container mb-3">
                        <?php $__empty_1 = true; $__currentLoopData = $sale->itemPenjualan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="cart-item-row">
                                ...
                                <div class="me-2">
                                    <form method="POST" action="<?php echo e(route('itempenjualan.update', $item->id)); ?>" class="m-0 form-update-qty">
                                        <?php echo csrf_field(); ?>
                                ...
                                <div>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $item)): ?>
                                        <form method="POST" action="<?php echo e(route('itempenjualan.destroy', $item->id)); ?>" class="m-0 form-hapus-item">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="submit" class="btn-delete-cart" title="Hapus Item" <?php echo e($sale->status === 'COMPLETED' ? 'disabled' : ''); ?>>
                    ...
                    <form id="checkoutForm" method="POST" action="<?php echo e(route('penjualan.update', $sale->id)); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <div class="mb-3">
                            <select id="paymentMethodSelect" name="payment_method" class="form-select rounded-pill px-3 shadow-none bg-light border" onchange="toggleCashInput()" required <?php echo e($sale->status === 'COMPLETED' ? 'disabled' : ''); ?>>
                        ...
                        <div id="cashInputContainer" class="mb-3 d-none">
                            <div class="input-group">
                                ...
                                <input type="number" id="cashAmountInput" name="cash_amount" class="form-control bg-light border-start-0 rounded-end-pill shadow-none" placeholder="Uang Diterima" oninput="calculateChange(); syncActiveQuickBtn();" <?php echo e($sale->status === 'COMPLETED' ? 'disabled' : ''); ?>>
                            </div>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $sale)): ?>
                        <form id="cancelTransactionForm" action="<?php echo e(route('penjualan.destroy', $sale->id)); ?>" method="POST" class="mt-2">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="submit" class="btn btn-link text-danger w-100 text-decoration-none small fw-semibold <?php echo e($sale->status === 'COMPLETED' ? 'disabled' : ''); ?>">
                                Batalkan Transaksi
                            </button>
                        </form>
                    <?php endif; ?>
        ...
        <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden">
            ...
            <div class="modal-body p-4">
                ...
                <div class="va-number-box text-center">
                    ...
                    <div id="bankAccountNumber" class="va-number-value"><?php echo e($bcaNumber); ?></div>
                    <div class="text-muted mt-1" style="font-size: 0.75rem;">
                        Atas Nama: <strong id="bankAccountHolder"><?php echo e($bcaHolder); ?></strong>
                    </div>
                </div>
                ...
                <div class="va-amount-row">
                    <div>
                        ...
                        <div class="amount-value">Rp <?php echo e(number_format($sale->total_pembayaran, 0, ',', '.')); ?></div>
                    </div>
                ...
                <details class="va-instructions">
                    ...
                    <ol>
                        ...
                        <li>Masukkan Nomor Virtual Account: <strong id="vaInlineRef"><?php echo e($bcaNumber); ?></strong></li>
                ...
                <details class="va-instructions">
                    ...
                    <ol>
                        ...
                        <li>Masukkan Nomor Virtual Account: <strong id="vaInlineRefAtm"><?php echo e($bcaNumber); ?></strong></li>
                ...
                <div id="qrSection" class="text-center d-none mb-3">
                    <img id="bankQrDisplay" src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=TRANSFER-BCA-<?php echo e($bcaNumberClean); ?>-TOTAL-<?php echo e($sale->total_pembayaran); ?>" alt="QR Transfer" class="img-fluid rounded-3 border bg-white p-2 shadow-sm" style="max-width: 160px;">
...
<div id="receipt-print">
    ...
    <table class="receipt-table">
        ...
        <?php if(isset($sale->bayar)): ?>
            <tr>
                <td>BAYAR</td>
                <td style="text-align: right;">Rp <?php echo e(number_format($sale->bayar, 0, ',', '.')); ?></td>
            </tr>
            <tr>
                <td>KEMBALI</td>
                <td style="text-align: right;">Rp <?php echo e(number_format($sale->kembali, 0, ',', '.')); ?></td>
            </tr>
        <?php endif; ?>
    </table>
...
<script>
    window.addEventListener('beforeprint', function () {
        ...
        style.textContent = '@page { size: <?php echo e($receiptPaperSize); ?> auto; margin: 0; }';
    });
    ...
    const bankData = {
        BCA: {
            name: "Bank BCA",
            number: "<?php echo e($bcaNumber); ?>",
            cleanNumber: "<?php echo e($bcaNumberClean); ?>",
            holder: "<?php echo e($bcaHolder); ?>",
            qrUrl: "https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=TRANSFER-BCA-<?php echo e($bcaNumberClean); ?>-TOTAL-<?php echo e($sale->total_pembayaran); ?>"
        },
        MANDIRI: {
            name: "Bank Mandiri",
            number: "<?php echo e($mandiriNumber); ?>",
            cleanNumber: "<?php echo e($mandiriNumberClean); ?>",
            holder: "<?php echo e($mandiriHolder); ?>",
            qrUrl: "https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=TRANSFER-MANDIRI-<?php echo e($mandiriNumberClean); ?>-TOTAL-<?php echo e($sale->total_pembayaran); ?>"
        }
    };
