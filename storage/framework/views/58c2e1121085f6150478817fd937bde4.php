...
<?php $__env->startSection('title', 'Profil Pengguna - POS System'); ?>
            ...
            <div class="card dashboard-card h-100">
                ...
                <div class="card-body p-4 text-center">
                    <div class="profile-avatar-container">
                        <?php if($user->photo && Illuminate\Support\Facades\Storage::disk('public')->exists($user->photo)): ?>
                            <img src="<?php echo e(asset('storage/' . $user->photo)); ?>" alt="Avatar" class="profile-avatar">
                        <?php else: ?>
                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($user->name)); ?>&background=7c3aed&color=ffffff&bold=true&size=200" alt="Avatar" class="profile-avatar">
                        <?php endif; ?>
                    </div>

                    <h3 class="fw-bold mb-2" style="color: var(--text-heading); font-size: 1.5rem;"><?php echo e($user->name); ?></h3>
                    <p class="text-muted mb-3" style="color: var(--text-muted);"><?php echo e($user->email); ?></p>

                    <div class="badge badge-purple px-4 py-2 rounded-pill fs-6 mb-4">
                        <i class="bi bi-shield-fill me-2"></i>
                        <?php echo e(ucfirst($user->role->name ?? $user->role->NAME ?? (is_string($user->role) ? $user->role : 'Admin'))); ?>
                    ...
                    <div class="mt-4 pt-4 border-top" style="border-color: var(--card-border) !important;">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="small fw-bold" style="color: var(--text-heading);">#<?php echo e(str_pad($user->id, 5, '0', STR_PAD_LEFT)); ?></span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="small" style="color: var(--text-muted);">Terdaftar Sejak</span>
                            <span class="small fw-bold" style="color: var(--text-heading);"><?php echo e($user->created_at->format('d M Y')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-control-plaintext fw-semibold" style="color: var(--text-heading); border: 1px solid var(--card-border); padding: 0.75rem; border-radius: 10px; background: var(--icon-bg);">
                                    #<?php echo e(str_pad($user->id, 5, '0', STR_PAD_LEFT)); ?>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-control-plaintext fw-semibold" style="color: var(--text-heading); border: 1px solid var(--card-border); padding: 0.75rem; border-radius: 10px; background: var(--icon-bg);">
                                    <?php echo e($user->created_at->timezone('Asia/Jakarta')->translatedFormat('d F Y, H:i')); ?> WIB
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-control-plaintext fw-semibold" style="color: var(--text-heading); border: 1px solid var(--card-border); padding: 0.75rem; border-radius: 10px; background: var(--icon-bg);">
                                    <?php echo e($user->updated_at->timezone('Asia/Jakarta')->translatedFormat('d F Y, H:i')); ?> WIB
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cadisetrama\resources\views/users/profile.blade.php ENDPATH**/ ?>