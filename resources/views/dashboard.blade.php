...
<style>
    ...
    .dashboard-header-banner {
        ...
        color: #ffffff;
        box-shadow: 0 12px 28px -6px rgba(124, 58, 237, 0.3);
        position: relative;
        overflow: hidden;
    }
...
<div class="container py-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div class="d-flex align-items-center">
            <div class="icon-box-modern bg-purple-subtle-custom me-3 shadow-sm">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card dashboard-card h-100 p-3">
                <div class="card-top-accent bg-purple-subtle-custom" style="background-color: var(--purple-text) !important;"></div>
                <div class="card-body p-0">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <span class="text-muted small fw-bold text-uppercase">Total Pendapatan</span>
                        <div class="icon-box-modern bg-purple-subtle-custom">
            ...
            <div class="card dashboard-card h-100">
                <div class="card-header bg-transparent border-0 pt-4 px-4 pb-2">
                    <div class="d-flex align-items-center gap-3">
                        <div class="icon-box-modern bg-purple-subtle-custom" style="width: 42px; height: 42px; font-size: 1.1rem;">
                            ...
                            @forelse($produkTerlaris as $produk)
                                <tr>
                                    ...
                                    <td class="pe-4 text-end">
                                        <span class="badge bg-purple-subtle-custom px-3 py-2 rounded-pill fw-bold">
