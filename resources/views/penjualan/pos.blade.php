                                    ...
                                    <div class="p-2 rounded-3 product-select-btn">
                                        <div class="row align-items-center g-2">
                                            ...
                                            <div class="col-2 col-sm-2 text-end">
                                                <button type="submit" class="btn btn-sm text-white rounded-circle d-inline-flex align-items-center justify-content-center shadow-sm {{ $sale->status === 'COMPLETED' ? 'disabled' : '' }}" style="width: 36px; height: 36px; background: linear-gradient(135deg, #7c3aed 0%, #a855f7 100%);" title="Tambah ke Keranjang">
