            ...
            <div class="card-body p-4 position-relative z-1 text-white">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                    <div>
                        ...
                        <h2 class="h3 fw-bold mb-1 text-white">Tambah Jenis</h2>
                        <p class="text-white-50 small mb-0">Tambahkan jenis produk baru untuk memperjelas kategori item.</p>
                    </div>
                    <div>
                ...
                <div class="card border-0 shadow-sm rounded-4 bg-white overflow-hidden form-card">
                    <div class="card-header bg-white border-bottom border-light-subtle py-3 px-4">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <h5 class="card-title fw-bold text-dark mb-0 fs-6">Form Jenis Produk</h5>
                        </div>
                    </div>
                    <div class="card-body p-4 p-lg-5">
                        <form action="{{ route('jenis.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_jenis" id="nama_jenis" class="form-control @error('nama_jenis') is-invalid @enderror" value="{{ old('nama_jenis') }}" placeholder="Contoh: Makanan" style="border-radius: 0.9rem;">
                                @error('nama_jenis')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="4" class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Masukkan deskripsi jenis..." style="border-radius: 0.9rem;">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
