...
@section('title', 'Kelola Users - POS ILHAM')
    ...
    <div class="banner-purple-gradient p-4 p-md-5 rounded-4 mb-4 position-relative overflow-hidden shadow-sm">
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 position-relative" style="z-index: 1;">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <a href="{{ route('admin.users.create') }}" class="btn btn-light rounded-pill px-4 shadow-sm fw-semibold d-inline-flex align-items-center gap-2" style="color: #7c3aed !important;">
                ...
                <table class="table table-hover align-middle mb-0 custom-table">
                    ...
                    @forelse($users as $user)
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="avatar-purple rounded-circle d-flex align-items-center justify-content-center shadow-sm overflow-hidden" style="width: 40px; height: 40px;">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-muted small">ID User: #{{ $user->id }}</span>
                                    </div>
                                </div>
                            </td>
