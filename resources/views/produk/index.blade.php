    ...
    <div class="banner-purple-gradient p-4 p-md-5 rounded-4 mb-4 position-relative overflow-hidden shadow-sm">
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 position-relative" style="z-index: 1;">
            <div>
                ...
                <p class="text-white opacity-75 small mb-0">Kelola inventaris, jenis produk, harga jual, dan stok barang toko Anda secara terpusat.</p>
            </div>
            <div class="d-flex flex-wrap gap-2">
                ...
                @can('create', App\Models\Produk::class)
                    <a href="{{ route('produk.create') }}" class="btn btn-light rounded-pill px-4 shadow-sm fw-semibold d-inline-flex align-items-center gap-2" style="color: #7c3aed !important;">
        ...
        <div class="col-6 col-md-3">
            <div class="card stat-card bg-white p-3 shadow-sm">
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-circle p-3 d-flex align-items-center justify-content-center" style="background: #f3e8ff; color: #7c3aed; width: 48px; height: 48px;">
        ...
        <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
            <form action="{{ route('produk.index') }}" method="GET">
                <div class="row g-2 justify-content-between align-items-center">
                    ...
                    <div class="col-md-8 col-lg-7 d-flex flex-wrap align-items-center justify-content-md-end gap-2">
                        
                        {{-- FILTER JENIS / KATEGORI --}}
                        <select name="jenis" class="form-select bg-search rounded-pill shadow-none border-0 w-auto" onchange="this.form.submit()">
                            ...
                            <option value="Cemilan / Snack" {{ request('jenis') == 'Cemilan / Snack' ? 'selected' : '' }}>Cemilan / Snack</option>
                ...
                <table class="table table-hover align-middle mb-0 custom-table">
                    ...
                    @forelse ($products as $product)
                        <tr class="product-row">
                            ...
                            <td>
                                <span class="badge badge-soft-info px-2 py-1 rounded-pill fw-medium">
                                    <i class="bi bi-tag-fill me-1"></i>{{ $product->jenis ?? 'Umum' }}
                                </span>
                            </td>
                            <td class="text-muted small">
                                <span class="badge badge-soft-purple px-2 py-1 rounded-pill fw-normal">
