                ...
                <div class="col-md-7 col-lg-8">
                    <div class="ps-md-3">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-sm-6">
                                <div class="price-box" style="background-color: #f3e8ff; border-color: #e9d5ff;">
                                    <span class="info-label d-block mb-1" style="color: #7c3aed;">Harga Jual</span>
                                    <span class="fs-4 fw-bold" style="color: #6b21a8;">
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-2 pt-2 no-print">
                            <a href="{{ route('produk.edit', $produk) }}" class="btn btn-gradient-purple d-inline-flex align-items-center gap-2">
